...
function Cabin({ cabin }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[3fr_4fr] gap-20 border border-primary-800 py-3 px-10 mb-24">
      ...
      <div>
        <h3 className="text-accent-100 font-black text-7xl mb-5 translate-x-[-254px] bg-primary-950 p-6 pb-1 w-[150%] hidden md:block">
          Cabin {name}
        </h3>
        <h3 className="text-accent-100 font-black text-6xl mb-5 bg-primary-950 md:hidden">
          Cabin {name}
        </h3>
